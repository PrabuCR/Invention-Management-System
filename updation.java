...
public class updation {
	...
	public void table_load(){
		  try{
		    pst = con.prepareStatement("select Invention_ID,Title,Invention_url,Author_Name from Research_Archive");
		    rs = pst.executeQuery();
	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					pst = con.prepareStatement("Insert into Research_Archive(Title,Invention_url,Author_Name)values(?,?,?)");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
		            ...
		            String example="select Title,Invention_url,Author_Name from Research_Archive where Invention_ID="+id+";";
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ID=IDtxt.getText();
				try {
					String hello="update Research_Archive set Title= ?,Invention_url= ?,Author_Name= ? where Invention_ID ="+ID+";";
		...
		btnClear_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ID=IDtxt.getText();
				try {
					String hello="delete from Research_Archive where Invention_ID ="+ID+";";
					pst = con.prepareStatement(hello);
					pst.executeUpdate();
	                System.out.println("he");
